...
class Controller_Mouse:
    ...
    def get_pixel_color_win32gui(self, i_x, i_y):
        i_desktop_window_id = win32gui.GetDesktopWindow()
    ...
    def get_custom_overlay_color_value_in_range_PIL(self, xDelta, yDelta, goal):
        coords = self.coords()
    ...
    def get_overlay_calculation(self):
        # 23 pixels high, down 36 for first black
        val = self.get_custom_overlay_color_value_in_range_PIL(xDelta = 0, yDelta = 36, goal = 0)
